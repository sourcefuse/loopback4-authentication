...
describe('getting apple oauth2 strategy with options', () => {
    ...
    it('should return 200 when client id is passed and passReqToCallback is set true', async () => {
        ...
        tslib_1.__decorate([
            ...
            (0, decorators_1.authenticate)("Apple Oauth 2.0" /* APPLE_OAUTH2 */, {
                clientID: 'string',
                clientSecret: 'string',
    ...
    function getAuthVerifier() {
        app
            .bind(keys_1.Strategies.Passport.APPLE_OAUTH2_VERIFIER)
...
class AppleAuthVerifyProvider {
    constructor() { }
    value() {
        return async (accessToken, refreshToken, decodedIdToken, profile, cd, req) => {
            return bearer_data_1.userWithoutReqObj;
        };
    }
}
//# sourceMappingURL=apple-oauth2.integration.js.map
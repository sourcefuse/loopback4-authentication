...
If you've noticed a bug or have a question, [search the issue tracker](https://github.com/sourcefuse/loopback4-authentication/issues) to see if
someone else in the community has already created a ticket. If not, go ahead and
[make one](https://github.com/sourcefuse/loopback4-authentication/issues/new/choose)!
...
up to date with loopback4-authentication's master branch:

```sh
git remote add upstream git@github.com:sourcefuse/loopback4-authentication.git
git checkout master
